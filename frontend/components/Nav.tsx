...
export default function Nav() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-56 bg-slate-900 border-r border-slate-800 flex flex-col z-20">
      ...
      <nav className="flex-1 py-3 px-3">
        {links.map(l => (
          <Link
            key={l.href}
            href={l.href}
            className={`flex items-center px-3 py-2.5 rounded-lg mb-0.5 text-sm font-medium transition-all ${
              path === l.href
